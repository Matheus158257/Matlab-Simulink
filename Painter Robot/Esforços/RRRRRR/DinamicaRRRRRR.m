...
%%%%%%%%%%%%%%%%% Encontro da matriz H em relaçãp ao referencial %%%%%%%%%%%%%%%%%
 ...
 %% Dinamica
   ...
   syms th1_dot th2_dot th3_dot th4_dot th5_dot th6_dot
    ...
    syms th1_dot2 th2_dot2 th3_dot2 th4_dot2 th5_dot2 th6_dot2
...
%     syms Ixx6 Iyy2 Izz6
    ...
    I4 = [(m4*(0.0075+0.01))/12  0    0;
          0    (m4*(0.0075+0.01))/12  0;
          0     0    m4*0.01/2];
      
    I5 = [(m5*(0.0075+0.01))/12  0    0;
          0    (m5*(0.0075+0.01))/12  0;
          0     0    m5*0.01/2];
      
    I6 = [(m6*(0.0075+0.01))/12  0    0;
          0    (m6*(0.0075+0.01))/12  0;
          0     0    m6*0.01/2];
