...
%     
    ...
    C3 = [C(3,1,1) C(3,2,1) C(3,3,1) C(3,4,1) ;
     ...
     % Ponto de referencia = 2m abaixo da base do robo
     syms g% acelera��o da gravidade
     P1 = 2*m1*g;%H_01(3,4)*m1*g;
     P2 = 2*m2*g;%H_02(3,4)*m2*g;
     P3=  (2-d3)*m3*g;%H_03(3,4)*m3*g;
     P4=  (2-d3)*m4*g;%H_04(3,4)*m4*g;
     P = P1+P2+P3+P4;
     P = simplify(P);
    ...
    % https://www.newmarksystems.com/linear-positioners/d-slide-linear-slide/
    % massa de 10kg por junta
    
    D = subs(D, [m1, m2, m3, m4, Iyy4], [15, 70, 30, 1, 0.15]);
    
    G = subs(G, [m1, m2, m3, m4, g], [15, 70, 30, 1, 9.81]);
